--criando a tabela principal do priority_jobs_snapshot 
...
--nesse caso, nao usaremos o VALUES, pois não vai ser um hardcode, aqui o select faz
--o trabalho de levar esses dados para tabela
SELECT 
    jpf.job_id,
    jpf.job_title_short,
